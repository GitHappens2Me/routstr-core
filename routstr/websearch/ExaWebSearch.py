...
class ExaWebSearch(BaseWebSearch):
    ...
    async def search(self, query: str, max_results: int = 10) -> SearchResult:
        ...
        try:
            ...
            api_response = await self._load_mock_data("exa_what_is_the_latest_news_about_the_Donald_Trump_peace_deal_Which_websites_did_you_search_be_brief_20251219_163302.json")
            # ---------------------------------------------------------------
